            ...
            <Container style={styles.container}>
                ...
                <Content style={styles.content}>
                    <View style={styles.header1}>
                        ...
                        <TouchableOpacity onPress={() => this.update_profile()} style={styles.item_view1}>
                    ...
                    <View style={styles.avatar_view}>
                        <TouchableOpacity onPress={() => this.change_photo()} style={styles.input1}>
                            <Text style={styles.label}>الصورة الشخصية</Text>
                            <Text style={styles.inputStyle}>إضغط هنا للتعديل</Text>
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <Image style={{width: 50, height: 50, borderRadius: 25, backgroundColor: colors.grey2}}
                    ...
                    <TextInput label={'الميلاد'}
                               ...
                               style={styles.input}/>
                    {this.state.birthday_error != '' && <Text style={styles.error}>{this.state.birthday_error}</Text>}
