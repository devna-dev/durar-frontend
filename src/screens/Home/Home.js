            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Activity',{id:item.id})} style={styles.item_view}>
                ...
                <ImageBackground style={styles.item_img}
                    ...
                    <ImageBackground style={styles.item_img} source={require('../../assets/images/shadow.png')}>
                        ...
                        <Text style={[styles.text,{marginTop:'15%'}]}>{item.title}</Text>
            ...
            <FlatList
              ...
              renderItem={(item) => (
                <HomeBookItem
                  ...
                  item={item.item}
                  image={
                    'https://api.kashback.co.uk/storage/HUE2pyizlNzMEVlNLhCzheTJxhO4k5pXMbBP0DXe.jpeg'
                  }
                />
              )}
            />
