            ...
            <Container style={styles.container}>
                ...
                {this.props.book.load ?
                    ...
                    <Content style={styles.content}>
                        ...
                        {this.props.book.activities.seminars &&this.props.book.activities.seminars.length != 0 && <TouchableOpacity onPress={() => this.props.navigation.navigate('Discussions',{type:1})} style={styles.bar}>
