...
export default class NotesBook extends Component {
    ...
    render() {
        return (
            <Container style={styles.container}>
                   ...
                   <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginHorizontal:5}}>
                    ...
                    <View style={styles.header1}>
                        <TouchableOpacity onPress={()=>this.setState({selected:0})}
                            ...
                            <Text style={this.state.selected == 0 ? styles.item_text : styles.active_item_text}>ملاحظات من الكتب</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={()=>this.setState({selected:1})}
                            ...
                            <Text style={this.state.selected == 1 ? styles.item_text : styles.active_item_text}>ملاحظات خاصه</Text>
                        </TouchableOpacity>
                    </View>
                ...
                <AddNotes visible={this.state.note}
