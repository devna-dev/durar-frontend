        ...
        return (
            <Container style={styles.container}>
                <Content style={styles.content}>
                    ...
                    <FlatList data={[{}, {}, {}, {}, {}]}
                              renderItem={(item) => <View style={[styles.view_item_list,{backgroundColor:item.index==1?colors.white:colors.grey2}]}>
                                  <View style={{width:50}}>
                                  <SvgUri uri={svg_photo.cup}/>
                                  </View>
                                  <View style={{justifyContent:'flex-end'}}>
                                      <Text style={[styles.item_text1,{fontSize:14,width:250}]}> من 1 إلى 100 نقطة</Text>
                                      <Text style={[styles.text3,{fontSize:13,width:250}]}>نظام النقاطعند قراءة كتاب أونلاين</Text>
                                  </View>
                              </View>}/>
                </Content>
            </Container>
